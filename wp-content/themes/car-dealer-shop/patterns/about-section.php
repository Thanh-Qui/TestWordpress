...
<!-- wp:group {"className":" wp-block-section about-sec alignfull","style":{"spacing":{"padding":{"right":"0px","left":"0px","top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"layout":{"type":"constrained","contentSize":"80%"}} -->
<div class="wp-block-group wp-block-section about-sec alignfull" style="padding-top:var(--wp--preset--spacing--80);padding-right:0px;padding-bottom:var(--wp--preset--spacing--80);padding-left:0px"><!-- wp:group {"className":"sec-header-box wow bounceInDown","layout":{"type":"default"}} -->
<div class="wp-block-group sec-header-box wow bounceInDown"><!-- wp:group {"className":"sec-header-box-inner","layout":{"type":"default"}} -->
...
<!-- wp:group {"className":"about-wrap wow bounceInDown","style":{"spacing":{"margin":{"bottom":"0"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group about-wrap wow bounceInDown" style="margin-bottom:0"><!-- wp:cover {"url":"<?php echo get_parent_theme_file_uri( '/assets/images/about.png' ); ?>","id":39,"dimRatio":0,"customOverlayColor":"#ac7768","isUserOverlayColor":false,"minHeight":450,"isDark":false,"sizeSlug":"full","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"default"}} -->
<div class="wp-block-cover is-light" style="margin-top:0;margin-bottom:0;min-height:450px"><img class="wp-block-cover__image-background wp-image-39 size-full" alt="" src="<?php echo get_parent_theme_file_uri( '/assets/images/about.png' ); ?>" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#ac7768"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
...
<!-- wp:image {"id":49,"sizeSlug":"full","linkDestination":"none","className":"about-car-img wow fadeInLeft"} -->
<figure class="wp-block-image size-full about-car-img wow fadeInLeft"><img src="<?php echo get_parent_theme_file_uri( '/assets/images/about1.png' ); ?>" alt="" class="wp-image-49"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->